...
export function listLinuxAccessibilityElements(options = {}) {
  return runHelper({ mode: "list", ...options });
}

export function linuxAccessibilityElementAction({ elementId, action, value = "" }) {
  return runHelper({ mode: "action", elementId, action, value });
}
