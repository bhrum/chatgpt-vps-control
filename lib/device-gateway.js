...
export function registerDeviceTools(server, options = {}) {
  ...
  server.registerTool(
    "device_call",
    {
      ...
      description: "Call one advertised MCP tool on a dynamically connected device. Obtain deviceId and toolName from list_devices; argumentsJson must be a JSON object.",
      inputSchema: {
